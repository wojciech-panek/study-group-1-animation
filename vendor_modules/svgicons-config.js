window.svgIconConfig = {
  ...
  navLeftArrow : {
    url : 'public/svg/nav-left-arrow.svg',
    animation : [
      {
        el : 'path',
        animProperties : {
  ...
  navUpArrow : {
    url : 'public/svg/nav-up-arrow.svg',
    animation : [
      {
        el : 'path',
        animProperties : {
  ...
  rightArrow : {
    url : 'public/svg/right-arrow.svg',
    animation : [
      {
        el : 'path',
        animProperties : {
